...
public class POIReadAndWriteWordDOCX {
     ...
     * <p>更新日期:[日期YYYY-MM-DD][更改人姓名][变更描述]。</p>
     */
    private static Map<String, Object> processParagraphs(List<XWPFParagraph> listParagraphs, Map<String, Object> param, XWPFDocument document) throws InvalidFormatException {
        Map<String, Object> result = new HashMap<String, Object>();
